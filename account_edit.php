	...
	<div class="container">
		...
		<form action="edit_confirmation.php" method="POST">
			...
			<div class="form-group row">
				<h1 class="col-12 mt-4 mb-4">Edit your account</h1>
			</div> <!-- row -->

			<div class="form-group row">
				<label for="email-id" class="col-sm-3 col-form-label text-sm-right">Username: <span class="text-danger">*</span></label>
				<div class="col-sm-9 col-md-6 col-lg-4">
					<input type="username" class="form-control" id="username-id" name="username" value="<?php echo $_SESSION['username']?>">
					<small id="username-error" class="invalid-feedback">Please enter a valid username that is not taken.</small>
				</div>
			</div> <!-- .form-group -->	
			...
			<div class="form-group row">
				...
				<div class="col-sm-9 mt-3">
					...
					<a href="delete_confirmation.php" role="button" class="btn btn-danger">Delete Account</a>

					<a href="account_details.php" role="button" class="btn btn-light">Cancel</a>
